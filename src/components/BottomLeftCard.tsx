...
export default function BottomLeftCard() {
  return (
    ...
    >
      ...
      >
        <div className="bg-[rgba(60,42,25,0.1)] p-1 rounded-full flex items-center justify-center">
          <ArrowUpRight className="w-4 h-4 text-[rgba(60,42,25,0.9)]" />
        </div>
        <span className="text-[14px] font-normal text-[rgba(60,42,25,0.9)]">Telegram</span>
      </motion.a>
    </motion.div>
  )
}
